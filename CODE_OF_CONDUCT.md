# Contributor Covenant Code of Conduct for the gcweb-jekyll theme project

([Français](#Code-de-conduite-pour-le-projet-nom-du-projet))

Contributors to repositories hosted in gcweb-jekyll are expected to follow the Contributor Covenant Code of Conduct, and those working within Government are also expected to follow the Values and Ethics Code for the Public Sector
...
# Code de conduite pour le projet gcweb-jekyll
<!--markdownlint-enable MD025-->

([English](#Contributor-Covenant-Code-of-Conduct-for-the-projectname-project))

Les contributeurs aux dépôts hébergés dans gcweb-jekyll sont tenus de respecter le Code de conduite du Pacte des contributeurs, et ceux qui travaillent au sein du gouvernement sont également tenus de respecter le Code de valeurs et d'éthique du secteur public.
